        ...
        <Card className="p-8 shadow-xl border-0 bg-card/90 backdrop-blur-sm rounded-2xl">
          <div className="space-y-6">
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-xs"><span className="bg-card px-2 text-muted-foreground">または</span></div>
            </div>

            <div className="space-y-3">
              <Button variant="outline" className="w-full h-11 font-medium">
                <GoogleIcon className="w-5 h-5 mr-2" /> Googleで続ける
              </Button>
              <Button variant="outline" className="w-full h-11 font-medium">
                <Instagram className="w-5 h-5 mr-2 text-pink-500" /> Instagramで続ける
              </Button>
            </div>
          </div>
        </Card>
